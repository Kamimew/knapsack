...
void SoL(long long N, long long W, std :: vector < vector <long long>> &sol, std :: vector <long long> &v, std :: vector <long long> &w){
    long long i, j;
    for (i = 0; i < N; i++){
		for (j = 0; j <= W; j++){
			if (w[i] > j){
...
void Arraysol(long long N,long long W, std:: vector <int> &solution, std :: vector <long long> &v, std :: vector <long long> &w ){
    long long i, j;
